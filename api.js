...
function getToken(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return util_1.default.constructFormData(Object.assign({ bda: util_1.default.getBda(ua, options.pkey, options.headers["Referer"], options.location), public_key: options.pkey, site: options.site, userbrowser: ua, rnd: Math.random().toString() }, Object.fromEntries(Object.keys(options.data).map(v => ["data[" + v + "]", options.data[v]]))))
    });
}
